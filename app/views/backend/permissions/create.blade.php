...
{{--  Maj:17/06/2013 - backend/permissions/create.blade.php --}}

{{-- Page title --}}
@section('title')
{{Lang::get('backend/permissions/actions.create.title')}}
@parent
@stop
...
<div class="page-header">
	<h3>
		{{Lang::get('backend/permissions/actions.create.description')}}
...
<form class="form-horizontal" method="post" action="" autocomplete="off">
  ...
  <div class="control-group {{ $errors->has('description') ? 'error' : '' }}">
    ...
    <div class="controls">
      <input class="input-xxlarge" type="text" name="description" id="description" value="{{ Input::old('description') }}" />
	...
	<div class="control-permission">
		<div class="controls">
			...
			<button type="submit" class="btn btn-success">{{Lang::get('backend/permissions/actions.buttons.create')}}</button>
		</div>
	</div>
</form>
@stop
