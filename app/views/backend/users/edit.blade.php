...
{{--  Maj:17/06/2013 - backend/users/edit.blade.php --}}
        ...
        <div class="controls">
          <div class="radio inline">
            <label for="perm_superuser_allow" >
              <input type="radio" value="1" id="perm_superuser_allow" name="permissions[superuser]" {{ (! empty($permissions['superuser']) ? ' checked="checked"' : '') }}>
          ...
          <div class="radio inline">
            <label for="perm_superuser_deny" >
              <input type="radio" value="0" id="perm_superuser_deny" name="permissions[superuser]" {{ (empty($permissions['superuser']) ? ' checked="checked"' : '') }}>
                        ...
                        <div class="control-group">
                          ...
                          <div class="radio">
                            <label for="perm_{{ $domain_name }}_{{ $field_name }}_{{ $action }}_inherit" >
                              <input type="radio" value="0" id="perm_{{ $domain_name }}_{{ $field_name }}_{{ $action }}_inherit" name="permissions[{{ $domain_name }}.{{ $field_name }}.{{ $action }}]" {{ ($permissions["$domain_name.$field_name.$action"] == 0 ? ' checked="checked"' : '') }}>
